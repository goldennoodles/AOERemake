...
public class TerrainPool : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < treeCount; i++) {
            ...
            trees[i] = Instantiate(treePrefabs[treeIndex], Vector3.zero, Quaternion.identity) as GameObject;
        ...
        for(int i = 0; i < rockCount; i++) {
            ...
            rocks[i] = Instantiate(rockPrefabs[rockIndex], Vector3.zero, Quaternion.identity) as GameObject;
